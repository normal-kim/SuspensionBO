function [Yout, Yout_LQR] = ForLoop_Quarter_Faster(count,road,Uin,Yin,Kx,sat_on,LQR_on,sat_level,Amat,Bmat)
%%
%%%%%%%%%%%%%%% inputs %%%%%%%%%%%%%%%%%%%
...
%%
Yk = [m1_vel,m1_pos,m2_vel,m2_pos]';
Yk_ = Amat * Yk + Bmat * [Uin; road];
...
if (LQR_on == 1)
    Yk_LQR = Amat * Yk + Bmat * [Uin_LQR;road];
    Yout_LQR(2) = Yk_LQR(1);
    Yout_LQR(3) = Yk_LQR(2);
    Yout_LQR(5) = Yk_LQR(3);
    Yout_LQR(6) = Yk_LQR(4);
